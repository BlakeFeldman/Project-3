...
import jacquie_st_pattys_day from '../assets/jacquie_st_pattys_day.jpg';
        ...
        <Container className={classes.cardGrid} maxWidth="lg">
          ...
          <Grid container spacing={4}>
            ...
            />
                  ...
                  <CardMedia
                    className={classes.cardMedia}
                    image={jacquie_st_pattys_day}
                    title="Jacquie at the St. Patrick's day parade"
                  />
                  <CardContent className={classes.cardContent}>
                    {/* <Typography gutterBottom variant="h5" component="h2">
                      Heading
                    ...
                    <Typography>
                    Jacquie at the St. Patrick's day parade
                    </Typography>
                  </CardContent>
            ...
            />
                  ...
                  <CardMedia
                    className={classes.cardMedia}
                    image={jacquie_in_tutu}
                    title="Jacquie in her birthday tutu"
                  />
                  <CardContent className={classes.cardContent}>
                    {/* <Typography gutterBottom variant="h5" component="h2">
                      Heading
            ...
            />
                  ...
                  <CardMedia
                    className={classes.cardMedia}
                    image={jacquie_and_daddy}
                    title="Jacquie and her dad hangin out on the couch"
                  />
                  <CardContent className={classes.cardContent}>
                    {/* <Typography gutterBottom variant="h5" component="h2">
                      Heading
                    ...
                    <Typography>
                    Jacquie and her dad hangin out on the couch
                    </Typography>
                  </CardContent>
            ...
            />
                  ...
                  <CardMedia
                    className={classes.cardMedia}
                    image={jacquie_with_remote}
                    title="Jacquie with the remote"
                  />
                  <CardContent className={classes.cardContent}>
                    {/* <Typography gutterBottom variant="h5" component="h2">
                      Heading
